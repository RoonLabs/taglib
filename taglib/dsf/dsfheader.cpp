...
unsigned long long DSFHeader::sampleCount() const
{
  return d->sampleCount;
}

unsigned long long DSFHeader::ID3v2Offset() const
{
  return d->ID3v2Offset;
}

unsigned long long DSFHeader::fileSize() const
{
  return d->fileSize;
}
...
void DSFHeader::parse(const TagLib::ByteVector &data)
{
  ...
  if (d->sampleRate != 2822400 && d->sampleRate != 5644800 && d->sampleRate != 5644800*2) {
